...
function Uxconference() {
  ...
  const title = "UX+ Conference 2024 Manila – My Experience";
  const description =
    "My first UX+ Conference experience in Manila: talks that inspired me, missed networking (thanks to IKEA meatballs), and lessons that reignited my design passion.";
  const imageUrl = "https://kerslypotter.com/assets/blog/ux_conference/Pic13.jpg"; 
  const url = "https://kerslypotter.com/blog/ux-conference";

  return (
    <>
      {/* ✅ Helmet ONLY for head/meta stuff */}
      <Helmet>
        <title>{title}</title>
